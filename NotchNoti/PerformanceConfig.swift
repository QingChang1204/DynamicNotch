...
struct NotificationHistoryRow: View {
    ...
    private var iconColor: Color {
        ...
        case .celebration: return Color(red: 1.0, green: 0.84, blue: 0)
        case .reminder: return .indigo
        case .download: return Color(red: 0, green: 0.8, blue: 0.8)
        case .upload: return Color(red: 0.58, green: 0.0, blue: 0.83)
        case .security: return Color(red: 0.5, green: 0, blue: 0)
        case .ai: return .purple
        case .sync: return Color(red: 0, green: 0.7, blue: 0.7)
        }
    }
